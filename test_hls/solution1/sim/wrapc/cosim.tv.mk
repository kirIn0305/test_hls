...
$(ObjDir)/tb_multi_apuint.cpp_pre.cpp.tb.o : tb_multi_apuint.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_multi_apuint.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/multi_apuint.cpp_pre.cpp.tb.o : multi_apuint.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling multi_apuint.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
